...
$merged = [
    ...
    'terminal_feed' => [],
    'modifications' => [],
    'unknown_fns' => (!empty($master_state['unknown_fns']) && $master_state['unknown_fns'] !== '0') ? $master_state['unknown_fns'] : '870',
    'unknown_thunks' => (!empty($master_state['unknown_thunks']) && $master_state['unknown_thunks'] !== '0') ? $master_state['unknown_thunks'] : '15',
    'unknown_dat' => (!empty($master_state['unknown_dat']) && $master_state['unknown_dat'] !== '0') ? $master_state['unknown_dat'] : '82,913',
    'unknown_ptr' => (!empty($master_state['unknown_ptr']) && $master_state['unknown_ptr'] !== '0') ? $master_state['unknown_ptr'] : '4,538',
    'unknown_floats' => (!empty($master_state['unknown_floats']) && $master_state['unknown_floats'] !== '0') ? $master_state['unknown_floats'] : '2,201',
    'unknown_strings' => (!empty($master_state['unknown_strings']) && $master_state['unknown_strings'] !== '0') ? $master_state['unknown_strings'] : '12,115',
    'unknown_vtables' => (!empty($master_state['unknown_vtables']) && $master_state['unknown_vtables'] !== '0') ? $master_state['unknown_vtables'] : '63',
    'unknown_vars' => (!empty($master_state['unknown_vars']) && $master_state['unknown_vars'] !== '0') ? $master_state['unknown_vars'] : '103,184',
    'total_fns' => (!empty($master_state['total_fns']) && $master_state['total_fns'] !== '0') ? $master_state['total_fns'] : '19660',
    'total_vars' => (!empty($master_state['total_vars']) && $master_state['total_vars'] !== '0') ? $master_state['total_vars'] : '103184',
    'total_mods_all_time' => 22232,
    'total_tokens' => 383700597,
    'tps' => 0,
